...
from pegar_moeda import nomes_moedas, conversoes_disponoveis
...
dic_conversoes_disponiveis = conversoes_disponoveis()

# criar e configurar os botoes e textos
...
campo_moeda_origem = customtkinter.CTkOptionMenu(janela, values= list(dic_conversoes_disponiveis.keys()), command=carregar_moeda_destino)
